...
int main()
{
	...
	// --------------------
	GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "2018-19427 Hanjun Kim", NULL, NULL);
	if (window == NULL)
	{
	...
	// tell GLSL where to find the data, and how to access them.
	// this layout is available in vertex shader.
	// position attribute
	...
	CameraTransform cam1 = CameraTransform();
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glm::mat4 view = glm::lookAt(cam1.position, cam1.lookAt, cam1.up);
